...
## Unsolved Issues 
Current status: I deployed the site here: http://a11y-toolkit.surge.sh/. Working with Jaime, UX Designer, to build out wireframes for well-designed, accessible site. Will continue to update changes as we build out the site. See schedule for latest updates/plan. I
